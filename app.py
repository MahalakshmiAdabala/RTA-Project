...
options_acc_area = ['Other', 'Office areas', 'Residential areas', 'Church areas'
                    ...
                    'Outside rurual areas', 'Hospital areas', 'Market areas'
...
options_cause = ['No distancing', 'Changing lane to the right', 
                 ...
                 "Getting off the vegicle improperly", 'Driving at high speeds',
                 'Overtuning ', 'Turnover', 'Overspeed', 'Overloading', 'Drunk driving',
...
features = ['hour','day_of_week','casualties','accident_cause','vehicles_involved','vehicle_type',
